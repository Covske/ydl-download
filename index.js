...
function isYouTubeShorts(link) {
    // Verifica se a URL contém a parte específica de shorts do YouTube
    return link.includes('/shorts/');
}


function converterLinkShortsParaWatch(linkShorts) {
    // Expressão regular para encontrar "shorts/" e substituir por "watch?v="
    const regex = /\/shorts\//;
  
    // Substituir "shorts/" por "watch?v="
    const linkWatch = linkShorts.replace(regex, "/watch?v=");
